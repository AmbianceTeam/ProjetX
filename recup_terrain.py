...
def init_terrain(init_str,listCellules,listInfoTerrain):
    ...
    for i in range (nb_cells): #Recuperation et instanciation des cellules 
        ...
        listCellules.append(Cellule(id_cellule,offsize,defsize,radius,x,y,prod))
...
listInfoTerrain = init_terrain(init_str,listCellules,listInfoTerrain)
